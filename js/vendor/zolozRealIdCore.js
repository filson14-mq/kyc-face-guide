  ...
  return r = [function (t, e, r) {
    ...
    var n = function (a) {
      ...
      var c, t = Object.prototype, s = t.hasOwnProperty, e = "function" == typeof Symbol ? Symbol : {},
        o = e.iterator || "@@iterator", r = e.asyncIterator || "@@asyncIterator", n = e.toStringTag || "@@toStringTag";

      function i(t, e, r, n) {
        var a, i, u, c, o = e && e.prototype instanceof m ? e : m, s = Object.create(o.prototype), f = new P(n || []);
      ...
      a.wrap = i;
      var p = "suspendedStart", h = "suspendedYield", d = "executing", y = "completed", v = {};
      ...
      return u.prototype = w.constructor = f, f.constructor = u, f[n] = u.displayName = "GeneratorFunction", a.isGeneratorFunction = function (t) {
        ...
        constructor: P, reset: function (t) {
          if (this.prev = 0, this.next = 0, this.sent = this._sent = c, this.done = !1, this.delegate = null, this.method = "next", this.arg = c, this.tryEntries.forEach(L), !t) for (var e in this) "t" === e.charAt(0) && s.call(this, e) && !isNaN(+e.slice(1)) && (this[e] = c)
        }, stop: function () {
          this.done = !0;
          ...
          for (var e = this.tryEntries.length - 1; 0 <= e; --e) {
            ...
            if (o.tryLoc <= this.prev) {
              var i = s.call(o, "catchLoc"), u = s.call(o, "finallyLoc");
              if (i && u) {
    ...
    "use strict";
    r.r(e);
    var n = r(0), g = r.n(n), o = r(1), x = r.n(o), a = r(2), i = r.n(a), u = r(3), c = r.n(u);
    ...
    function w(e, t) {
      ...
      return console.log("finishWebTask", e), new Promise(function (t) {
        b(function () {
          AlipayJSBridge.call("zimIdentity", {action: "finishWebTask", status: e, nextIndex: r}, function () {
            return t()
          })
        })
      })
    ...
    function _(t) {
      return new Promise(function (e) {
        b(function () {
          AlipayJSBridge.call("hummerFoundation", {action: "needRpc", type: t}, function (t) {
            return e(t)
          })
        })
      })
    ...
    function k(t) {
      return new Promise(function (e) {
        b(function () {
          AlipayJSBridge.call("hummerFoundation", {action: "sendRpc", type: t}, function (t) {
            return e(t)
          })
        })
      })
    ...
    function S(t) {
      return new Promise(function (e) {
        b(function () {
          AlipayJSBridge.call("hummerFoundation", {action: "getOutputParams", type: t}, function (t) {
            return e(t)
          })
        })
      })
    ...
    function L(t) {
      return new Promise(function (e) {
        b(function () {
          AlipayJSBridge.call("hummerFoundation", {action: "query", key: t}, function (t) {
            return e(t)
          })
        })
      })
    ...
    function P(t, r, n) {
      return new Promise(function (e) {
        b(function () {
          AlipayJSBridge.call("hummerFoundation", {action: "add", key: t, value: r, pipeType: n}, function (t) {
            return e(t)
          })
        })
      })
    ...
    function A(t, e) {
      b(function () {
        AlipayJSBridge.call("hummerFoundation", {action: "logging", logSeedID: t, logMessage: e})
      })
    }
    ...
    var s = function () {
      ...
      var r, t;
      return c()(e, [{
        key: "getInputParams", value: (t = x()(g.a.mark(function t() {
          var e, a, r, n;
            ...
            for (; ;) switch (t.prev = t.next) {
              case 0:
                return e = function () {
                  ...
                  b(function () {
                    AlipayJSBridge.call("hummerFoundation", {action: "getInputParams"}, function (t) {
                      return e(t)
                    })
                  })
                });
        ...
        key: "end", value: (r = x()(g.a.mark(function t(e) {
          var r, n, o, c, i, u, a, s, f, l, p, h, d, y, v = this, m = arguments;
          return g.a.wrap(function (t) {
            for (; ;) switch (t.prev = t.next) {
              case 0:
                return r = 1 < m.length && void 0 !== m[1] ? m[1] : {}, n = {
                  ...
                  var t = x()(g.a.mark(function t() {
                    ...
                    return g.a.wrap(function (t) {
                      for (; ;) switch (t.prev = t.next) {
                        case 0:
                          return A("alertAppear", {reason: "systemError"}), t.next = 3, E(o("system_error_title"), o("system_error_msg"), o("system_error_got_it"));
                        case 3:
                          return e = t.sent, A("alertChoose", {choose: e.positive}), t.abrupt("return", e);
                        case 6:
                        case"end":
                          return t.stop()
                      }
                  ...
                  var t = x()(g.a.mark(function t() {
                    ...
                    return g.a.wrap(function (t) {
                      for (; ;) switch (t.prev = t.next) {
                        case 0:
                          return A("alertAppear", {reason: "networkError"}), t.next = 3, E(o("network_error_title"), o("network_error_msg"), o("network_error_got_it"));
                        case 3:
                          return e = t.sent, A("alertChoose", {choose: e.positive}), t.abrupt("return", e);
                        case 6:
                        case"end":
                  ...
                  var t = x()(g.a.mark(function t() {
                    ...
                    return g.a.wrap(function (t) {
                      for (; ;) switch (t.prev = t.next) {
                        case 0:
                          return A("alertAppear", {reason: "retryLimit"}), t.next = 3, E(o("fe_retry_max_title"), o("fe_retry_max_msg"), o("fe_retry_max_got_it"));
                        case 3:
                          return e = t.sent, A("alertChoose", {choose: e.positive}), t.abrupt("return", e);
                        case 6:
                        case"end":
                  ...
                  var e = x()(g.a.mark(function t(e) {
                    ...
                    return g.a.wrap(function (t) {
                      for (; ;) switch (t.prev = t.next) {
                        case 0:
                          return b(function () {
                            AlipayJSBridge.call("hummerFoundation", {action: "showLoadingDialog"})
                          }), t.next = 3, k(e);
                        case 3:
                          if (r = t.sent, b(function () {
                            AlipayJSBridge.call("hummerFoundation", {action: "hideLoadingDialog"})
                          }), r.success) {
                            t.next = 9;
                            break
                          }
                          return t.next = 8, i();
                        case 8:
                          return t.abrupt("return", {retCode: 0});
                        case 9:
                        ...
                        case 16:
                          return A("ztech_system_error", {subCode: a[0].retCodeSub}), t.next = 19, c();
                        case 19:
                        ...
                        case 26:
                          return t.abrupt("break", 28);
                        case 27:
                          return t.abrupt("return", {retCode: 1, response: a[0]});
                        case 28:
                          return t.abrupt("return", {retCode: 0});
                        case 29:
                        case"end":
              ...
              case 37:
                return console.log("-end ret-", {retCode: 0}), t.abrupt("return", {retCode: 0});
              case 39:
                t.next = 47;
                break;
              case 41:
